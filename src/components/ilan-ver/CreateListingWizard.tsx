    ...
    <div className="mx-auto max-w-3xl space-y-8 pb-16">
      ...
      {err ? (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div className="max-w-md w-full rounded-2xl border-2 border-red-300 bg-white p-6 shadow-2xl">
            ...
            <button
              onClick={() => setErr(null)}
              className="w-full rounded-lg bg-red-600 px-4 py-3 font-bold text-white transition hover:bg-red-700 active:bg-red-800"
            >
              Anladım
            </button>
          </div>
